...
describe('Service Tests', () => {
    describe('Atividade Service', () => {
        ...
        beforeEach(() => {
            ...
            elemDefault = new Atividade(0, 0, 'AAAAAAA');
        });
        ...
        describe('Service methods', async () => {
            ...
            it('should create a Atividade', async () => {
            ...
            it('should update a Atividade', async () => {
                const returnedFromService = Object.assign(
                    {
                        codigoAtividade: 1,
                        nome: 'BBBBBB'
            ...
            it('should return a list of Atividade', async () => {
                const returnedFromService = Object.assign(
                    {
                        codigoAtividade: 1,
                        nome: 'BBBBBB'
            ...
            it('should delete a Atividade', async () => {
