...
describe('Service Tests', () => {
    describe('Entrega Service', () => {
        ...
        describe('Service methods', async () => {
            ...
            it('should create a Entrega', async () => {
            ...
            it('should update a Entrega', async () => {
                const returnedFromService = Object.assign(
                    {
                        quantidade: 1
                    },
            ...
            it('should return a list of Entrega', async () => {
                const returnedFromService = Object.assign(
                    {
                        quantidade: 1
                    },
            ...
            it('should delete a Entrega', async () => {
