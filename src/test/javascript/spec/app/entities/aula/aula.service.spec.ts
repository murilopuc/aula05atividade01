...
describe('Service Tests', () => {
    describe('Aula Service', () => {
        ...
        beforeEach(() => {
            ...
            elemDefault = new Aula(0, 0, 'AAAAAAA');
        });
        ...
        describe('Service methods', async () => {
            ...
            it('should return a list of Aula', async () => {
                const returnedFromService = Object.assign(
                    {
                        quantidade: 1,
                        data: 'BBBBBB'
