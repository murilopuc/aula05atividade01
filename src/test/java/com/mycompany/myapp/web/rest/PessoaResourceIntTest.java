...
public class PessoaResourceIntTest {
    ...
    private static final Integer DEFAULT_CODIGO_PESSOA = 1;
    private static final Integer UPDATED_CODIGO_PESSOA = 2;
    ...
    public static Pessoa createEntity(EntityManager em) {
        Pessoa pessoa = new Pessoa()
            .codigoPessoa(DEFAULT_CODIGO_PESSOA)
            .nome(DEFAULT_NOME);
        return pessoa;
    }
    ...
    public void createPessoa() throws Exception {
        ...
        assertThat(testPessoa.getCodigoPessoa()).isEqualTo(DEFAULT_CODIGO_PESSOA);
    ...
    public void getAllPessoas() throws Exception {
        ...
        restPessoaMockMvc.perform(get("/api/pessoas?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].codigoPessoa").value(hasItem(DEFAULT_CODIGO_PESSOA)))
    ...
    public void getPessoa() throws Exception {
        ...
        restPessoaMockMvc.perform(get("/api/pessoas/{id}", pessoa.getId()))
            ...
            .andExpect(jsonPath("$.codigoPessoa").value(DEFAULT_CODIGO_PESSOA))
    ...
    public void updatePessoa() throws Exception {
        ...
        updatedPessoa
            .codigoPessoa(UPDATED_CODIGO_PESSOA)
            .nome(UPDATED_NOME);
        ...
        Pessoa testPessoa = pessoaList.get(pessoaList.size() - 1);
        assertThat(testPessoa.getCodigoPessoa()).isEqualTo(UPDATED_CODIGO_PESSOA);
