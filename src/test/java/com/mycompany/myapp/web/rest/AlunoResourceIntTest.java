...
public class AlunoResourceIntTest {
    ...
    private static final Integer DEFAULT_CODIGO_ALUNO = 1;
    private static final Integer UPDATED_CODIGO_ALUNO = 2;
    ...
    public static Aluno createEntity(EntityManager em) {
        Aluno aluno = new Aluno()
            .codigoAluno(DEFAULT_CODIGO_ALUNO)
            .nome(DEFAULT_NOME);
        return aluno;
    }
    ...
    public void createAluno() throws Exception {
        ...
        assertThat(testAluno.getCodigoAluno()).isEqualTo(DEFAULT_CODIGO_ALUNO);
    ...
    public void getAllAlunos() throws Exception {
        ...
        restAlunoMockMvc.perform(get("/api/alunos?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].codigoAluno").value(hasItem(DEFAULT_CODIGO_ALUNO)))
    ...
    public void getAluno() throws Exception {
        ...
        restAlunoMockMvc.perform(get("/api/alunos/{id}", aluno.getId()))
            ...
            .andExpect(jsonPath("$.codigoAluno").value(DEFAULT_CODIGO_ALUNO))
    ...
    public void updateAluno() throws Exception {
        ...
        updatedAluno
            .codigoAluno(UPDATED_CODIGO_ALUNO)
            .nome(UPDATED_NOME);
        ...
        Aluno testAluno = alunoList.get(alunoList.size() - 1);
        assertThat(testAluno.getCodigoAluno()).isEqualTo(UPDATED_CODIGO_ALUNO);
