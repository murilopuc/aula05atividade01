...
public class ProfessorResourceIntTest {
    ...
    private static final Integer DEFAULT_CODIGO_PROFESSOR = 1;
    private static final Integer UPDATED_CODIGO_PROFESSOR = 2;
    ...
    public static Professor createEntity(EntityManager em) {
        Professor professor = new Professor()
            .codigoProfessor(DEFAULT_CODIGO_PROFESSOR)
            .nome(DEFAULT_NOME);
        return professor;
    }
    ...
    public void createProfessor() throws Exception {
        ...
        assertThat(testProfessor.getCodigoProfessor()).isEqualTo(DEFAULT_CODIGO_PROFESSOR);
    ...
    public void getAllProfessors() throws Exception {
        ...
        restProfessorMockMvc.perform(get("/api/professors?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].codigoProfessor").value(hasItem(DEFAULT_CODIGO_PROFESSOR)))
    ...
    public void getProfessor() throws Exception {
        ...
        restProfessorMockMvc.perform(get("/api/professors/{id}", professor.getId()))
            ...
            .andExpect(jsonPath("$.codigoProfessor").value(DEFAULT_CODIGO_PROFESSOR))
    ...
    public void updateProfessor() throws Exception {
        ...
        updatedProfessor
            .codigoProfessor(UPDATED_CODIGO_PROFESSOR)
            .nome(UPDATED_NOME);
        ...
        Professor testProfessor = professorList.get(professorList.size() - 1);
        assertThat(testProfessor.getCodigoProfessor()).isEqualTo(UPDATED_CODIGO_PROFESSOR);
